...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2024 at 04:07 PM
...
INSERT INTO `applied_jobs` (`id`, `job_id`, `freelancer_id`, `employer_id`, `apply_date`, `status`) VALUES
(1, 4, 2, 0, '2024-09-25 20:31:00', NULL),
(2, 3, 2, 2, '2024-09-30 20:25:27', NULL),
(3, 5, 2, 3, '2024-10-07 14:02:25', NULL);
...
(3, 'Game in web', 'full-time', '100000-200000', 'On time', '2 monts', 'HTML, CSS', 2, 'Not after the deadline lease'),
(4, 'Game in web', 'part-time', '100000-300000', 'Brooo', '2 monts', 'HTML, CSS', 2, 'I want'),
(5, 'Job ', 'full-time', '100000-300000', 'We are seeking a highly motivated and detail-oriented Software Engineer to join our dynamic development team. In this role, you will be responsible for designing, developing, testing, and maintaining software applications across various platforms. You will collaborate closely with cross-functional teams to define system requirements, ensure code quality, and provide technical support. The ideal candidate is proficient in multiple programming languages, has a strong understanding of software development methodologies, and is passionate about solving complex technical challenges. Excellent communication skills and a team-oriented mindset are essential for success in this position.', '2 monts', 'HTML, CSS, Javascript', 3, 'Professional Conduct\r\nMaintain a high level of professionalism at all times.\r\nTreat colleagues, clients, and stakeholders with respect.\r\nAdhere to company policies and guidelines on workplace behavior.\r\n2. Work Hours &amp; Attendance\r\nBe punctual and adhere to the agreed-upon working hours.\r\nNotify your supervisor in advance if you&#039;re going to be late or absent.\r\nAccurately log your working hours if required.'),
(6, 'Job ', 'full-time', '100000-200000', 'sjkdfksn', '2 monthd', 'HTML, CSS, Javascript', 2, 'I want this on time');
